...
<section id="main-hero">
    ...
    <div class="container">
        ...
        <div class="main-content" data-aos="zoom-in" data-aos-duration="1500">
            ...
            <p class="">Discover verified accommodations near your college or workplace. Simple search, transparent pricing, and zero hassle.Discover verified accommodations near your college or workplace. Simple search, transparent pricing, </p>
...
<!-- Flats tab  section  -->
<section id="property-section" class="">
    <div class="container">
        <!-- Heading -->
        <div class="text-center mb-4">
            <h2 class="sec-title" data-aos="flip-up"data-aos-duration="1500">Find the Perfect Place for You</h2>
            <p class="sec-subtitle"data-aos="zoom-in" data-aos-duration="1500">Whether it's a shared PG or a private flat, explore options that feel like home.</p>
        </div>
        ...
        " data-aos-duration="1500">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="flats-tab" data-bs-toggle="tab" data-bs-target="#flats" type="button" role="tab" aria-controls="flats" aria-selected="true">Flats</button>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <div class="tab-content" id="propertyTabContent">
            ...
            <div class="tab-pane fade" id="pg" role="tabpanel" aria-labelledby="pg-tab">
                <div id="property-cards-row" class="cards-row">
                    <div class="property-card text-center">
                        <img src="assets/images/icons/f-1.png" alt="1BHK Flat" class="card-icon">
                        <div>1BHK Flat</div>
                    </div>
                    <div class="property-card text-center">
                        <img src="assets/images/icons/f-1.png" alt="1BHK Flat" class="card-icon">
            ...
            <!-- Flats -->
            <div class="tab-pane fade show active" id="flats" role="tabpanel" aria-labelledby="flats-tab">
                <div id="property-cards-row" class="cards-row">
                    <div class="property-card text-center">
                        <img src="assets/images/icons/f-1.png" alt="1BHK Flat" class="card-icon">
                        <div>1BHK Flat</div>
    ...
    <div class="container mt-3 mt-md-5 flat-tab-sec-card-cont">
        <div class="row" data-aos="zoom-in" data-aos-duration="1500">
            ...
            <div class="sec-bottom-btn d-flex justify-content-center">
                <a href="service.php" class="sons-btn btn-outline">view All</a>
            </div>
...
<section id="explore-properties">
    <div class="container">
        ...
        <ul>
            <li>
                <h2 class="sec-title" data-aos="flip-up"data-aos-duration="1500">Discover What Makes Our PG & Flat Rentals Stand Out</h2>
                <p class="sec-subtitle" data-aos="zoom-in" data-aos-duration="1500">Explore our premium selection of properties</p>
            </li>
            <li>
...
<section id="discover-rental">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <h2 class="mb-3 sec-title" data-aos="flip-up"data-aos-duration="1500">Discover What Makes Our PG & Flat Rentals Stand Out</h2>
                <p class="mb-4 sec-subtitle">Finding the perfect place to stay shouldn’t be stressful. Whether you’re a student, working professional, or family, we make your accommodation search simple, transparent, and affordable — from browsing to booking.</p>
                    ...
                    <div class="vs-list">
                        ...
                        <div class="vs-slide" data-index="0">
                            ...
                            <div class="vs-slide-content">
                                ...
                                <p>Explore fully-furnished PGs with meals, Wi-Fi, and all the essentials — all verified and ready for you.</p>
                            </div>
                        </div>
    ...
    <div class="container">
        <ul>
            <li>
                ...
                <p class="sec-subtitle" data-aos="zoom-in" data-aos-duration="1500">Find your perfect rental home from apartments to villas</p>
            </li>
            <li>
                <a href="service-detail.php">view All <i class="fa-solid fa-arrow-right"></i></a>
            </li>
...
<section id="find-property" class="d-flex align-items-center justify-content-center text-center">
    ...
    <div class="content text-white">
        ...
        <p class="mb-4 sec-subtitle" data-aos="zoom-in" data-aos-duration="1500">Join thousands of satisfied customers who found their perfect home with us</p>
    ...
    <div class="container">
        <ul>
            <li>
                ...
                <p class="sec-subtitle" data-aos="zoom-in" data-aos-duration="1500">Comfortable and affordable PG options for students and working professionals</p>
            </li>
            <li>
                <a href="service-detail.php">view All <i class="fa-solid fa-arrow-right"></i></a>
            </li>
...
<section id="testimonials">
    <div class="container">
        <h2 class="sec-title" data-aos="flip-up" data-aos-duration="1500" data-aos-offset="200">Hear From Our Customers</h2>
        <p class="sec-subtitle" data-aos="zoom-in" data-aos-duration="1500">Genuine feedback from tenants and owners who trust our platform.</p>
    ...
    <div class="overlay">
        <div class="container">
            <div class="row text-center text-white py-5">
                ...
                <div class="col-md-3 col-6 mb-4" data-aos="fade-down" data-aos-duration="2000" data-aos-offset="200">
                ...
                <div class="col-md-3 col-6 mb-4" data-aos="fade-down" data-aos-duration="1500" data-aos-offset="200">
